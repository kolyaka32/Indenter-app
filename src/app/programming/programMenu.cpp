...
title(_window, {"Programming", "Программирование"}, {_X, _Y-_H*0.45f, .frame=2, .height=Info}),
...
stoppedInfo(_window, {"Program stopped", "Программа остановлена"}, {_X+_W*0.16f, _Y-_H*0.38f}, 1000),
netConnectedInfo(_window, {"Not connected", "Не подключён"}, {_X+_W*0.16f, _Y-_H*0.38f}, 1000),
