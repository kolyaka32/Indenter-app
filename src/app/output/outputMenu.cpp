...
title(_window, _X, _Y-_H*0.45, {"Getted data", "Полученные данные"}, 2, GUI::Aligment::Left, Height::Info),
...
forceText(_window, _X-0.08, _Y+_H*0.25, {"Last force: %.1f", "Последние усилие: %.1f"}, GUI::Aligment::Left),
tempText(_window, _X-0.08, _Y+_H*0.30, {"Last temperature: %.1f", "Последняя температура: %.1f"}, GUI::Aligment::Left),
